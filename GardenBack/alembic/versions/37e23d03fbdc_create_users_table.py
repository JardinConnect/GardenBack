...
Revision ID: 37e23d03fbdc
Revises: 
Create Date: 2025-07-08 15:55:51.490799
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_arduino_nodes_api_key'), 'arduino_nodes', ['api_key'], unique=True)
    op.create_index(op.f('ix_arduino_nodes_id'), 'arduino_nodes', ['id'], unique=False)
    op.create_index(op.f('ix_arduino_nodes_name'), 'arduino_nodes', ['name'], unique=False)
    op.create_index(op.f('ix_arduino_nodes_space_id'), 'arduino_nodes', ['space_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('arduino_node_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['arduino_node_id'], ['arduino_nodes.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_sensors_arduino_node_id'), 'sensors', ['arduino_node_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_sensors_arduino_node_id'), table_name='sensors')
    ...
    op.drop_index(op.f('ix_arduino_nodes_space_id'), table_name='arduino_nodes')
    op.drop_index(op.f('ix_arduino_nodes_name'), table_name='arduino_nodes')
    op.drop_index(op.f('ix_arduino_nodes_id'), table_name='arduino_nodes')
    op.drop_index(op.f('ix_arduino_nodes_api_key'), table_name='arduino_nodes')
    op.drop_table('arduino_nodes')
